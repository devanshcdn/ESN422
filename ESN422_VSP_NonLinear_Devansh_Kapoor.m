...
% dgdk = @(k, v0, z) (z/k)*(1/(v0+k*z)) - (1/k^2)*(log(v0+k*z) - log(v0));
...
d2gdk2 = diff(dgdk, k);
d2gdv02 = diff(dgdv0, v0);
d2gdkdv0 = diff(dgdk, v0);
d2gdv0dk = diff(dgdv0, k); % same as d2Hdkdv0
